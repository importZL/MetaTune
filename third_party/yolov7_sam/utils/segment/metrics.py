...
KEYS = [
    ...
    "x/lr2",
    "test/box_loss",
    "test/seg_loss",  # held-out test loss for overfitting analysis
    "test/obj_loss",
    "test/cls_loss",
    "train/mAP_0.5(B)",
    "train/mAP_0.5(M)",  # mAP on train_dataset (after random_split) for overfitting analysis
    "train/mAP_0.75(B)",
    "train/mAP_0.75(M)",
    "train/mAP_0.5:0.95(B)",
    "train/mAP_0.5:0.95(M)",
    "test/mAP_0.5(B)",
    "test/mAP_0.5(M)",
    "test/mAP_0.75(B)",
    "test/mAP_0.75(M)",
